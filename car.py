...
page = requests.get(
    'https://www.carpages.ca/used-cars/search/?num_results=50&fueltype_id%5b0%5d=3&fueltype_id%5b1%5d=7&p=3')
...
while counter < 10:
    ...
    postings = soup.find_all('div', class_='media soft push-none rule') # link of
    ...
    soup = BeautifulSoup(page.text, 'htlm5lib')
    counter += 1
